...
class NovalnetInstalmentInvoicePaymentMethod extends PaymentMethodService
{
    ...
    {
       if ($this->configRepository->get('Novalnet.novalnet_instalment_invoice_payment_active') == 'true') {
        
        $active_payment_allowed_country = 'true';
        if ($allowed_country = $this->configRepository->get('Novalnet.novalnet_instalment_invoice_allowed_country')) {
        ...
        $minimum_amount = trim($this->configRepository->get('Novalnet.novalnet_instalment_invoice_minimum_order_amount'));
        ...
        $maximum_amount = trim($this->configRepository->get('Novalnet.novalnet_instalment_invoice_maximum_order_amount'));
    ...
    {   
        $name = trim($this->configRepository->get('Novalnet.novalnet_instalment_invoice_payment_name'));
    ...
    {
        $logoUrl = $this->configRepository->get('Novalnet.novalnet_instalment_invoice_payment_logo');
